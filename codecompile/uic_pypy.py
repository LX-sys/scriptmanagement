...
deal_Code(r"D:\code\scriptmanagement\UI\JSM_b_system\account_sys.py",
          outfile=r"D:\code\scriptmanagement\UI\JSM_b_system\account_sys.py", c_name="AccountSys", inheritance_name="QWidget")
