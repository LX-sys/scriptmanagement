...
deal_Code(r"D:\code\scriptmanagement\core\JSM_b_system\personage_js_UI.py",
          outfile=r"D:\code\scriptmanagement\core\JSM_b_system\personage_js_UI.py", c_name="PersonageJS", inheritance_name="QWidget")
